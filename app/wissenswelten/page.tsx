...
const investigationRhythms:Record<string,{title:string;text:string}[]>={
  ...
  philosophie:[{title:'Vier Sätze hören',text:'Markiert Veränderungen von Betonung, Tempo und Pause.'},{title:'Gesten vergleichen',text:'Prüft, welches Wort welche körperliche Erwartung auslöst.'},{title:'Übersetzung verantworten',text:'Trennt Textbefund, Fausts Vorverständnis und eigene Wirkung.'}],
